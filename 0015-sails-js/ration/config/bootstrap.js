...
module.exports.bootstrap = async function () {
    ...
    if (
      ...
      sails.log(
        'Skipping v' +
          ...
          ' bootstrap script...  (because its already been run)'
      );
      sails.log(
  ...
  await User.createEach([
    ...
    {
      emailAddress: 'fredy@example.com',
      fullName: 'Fredy Castellón',
      isSuperAdmin: true,
      password: await sails.helpers.passwords.hashPassword('P@ssw0rd')
    }
  ]);
